...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("10,000 at 6% interest = " + calculateInterest(10000.0, 6));
...
//      for(init; termination; increment)
        ...
        for (int i = 8; i < 15; i++) {
            System.out.println("Loop " + i + " Hello There!");
        }
        System.out.println("****************************");
    ...
    // if it is a prime number, print it out AND increment a cont of the
